...
public class GameSaveController {
    ...
    public ResponseEntity<ApiResponse<GameSaveDto>> uploadSave(
            ...
            @RequestParam(value = "isAutoSave", defaultValue = "false") Boolean isAutoSave)
            throws Exception {
        GameSaveDto.UploadRequest request =
                GameSaveDto.UploadRequest.builder()
                        .gameSlug(gameSlug)
                        .saveName(saveName)
    ...
    public ResponseEntity<ApiResponse<List<GameSaveDto>>> getSavesByGame(
            @AuthenticationPrincipal UserPrincipal user, @PathVariable String gameSlug) {
    ...
    public ResponseEntity<ApiResponse<GameSaveDto>> getSave(
            @AuthenticationPrincipal UserPrincipal user, @PathVariable UUID saveId)
            throws Exception {
    ...
    public ResponseEntity<InputStreamResource> downloadSave(
        ...
        return ResponseEntity.ok()
                .header(
                        ...
                        "attachment; filename=\"" + save.getSaveName() + "\"")
    ...
    public ResponseEntity<ApiResponse<GameSaveDto>> updateSave(
        ...
        GameSaveDto.UpdateRequest request =
                GameSaveDto.UpdateRequest.builder()
                        .saveName(saveName)
                        .description(description)
                        .build();
    ...
    public ResponseEntity<InputStreamResource> downloadHistoryVersion(
        ...
        InputStream inputStream =
                gameSaveService.downloadHistoryVersion(user.getId(), saveId, historyId);
